...
- If you use the filter with the white-list method, It will provide tighter security services for web site than the existing filter that uses the black-list method
